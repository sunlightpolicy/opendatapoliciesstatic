...
function show_map(data) {
  ...
  var wwcIcon = L.icon({ iconUrl: '{{ site.baseurl }}/assets/images/pin-wwc.png', iconSize: [24, 38] });
  var odpIcon = L.icon({ iconUrl: '{{ site.baseurl }}/assets/images/pin.png', iconSize: [24, 38]});
