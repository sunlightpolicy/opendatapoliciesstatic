...
1. data to which an agency may deny access pursuant to any provision of a federal, State, or local law, rule, or regulation, including, but not limited to, the Freedom of Information Act;
...
(a) There is hereby established an open operating standard, to be known as "Illinois Open Data", for the State of Illinois.

Under this open operating standard, each agency of State government under the jurisdiction of the Governor shall make available public data sets of public information. Any unit of local government may adopt the State standard for itself.
...
(a) Public data sets that are made available on the Internet by agencies shall be accessible through a single web portal that is linked to data.illinois.gov or any successor website maintained by, or on behalf of, the State of Illinois.
...
2. Public data sets shall be updated as often as is necessary to preserve the integrity and usefulness of the data sets, to the extent that the agency regularly maintains or updates the public data set.
